...
if __name__=="__main__":
    ...
    np.savetxt("msd.dat", np.column_stack((msd_timesteps, msd_normalized[0], msd_normalized[1], msd_normalized[2], msd_normalized[3])), header="Time(tsteps)\tMSD_region1\tMSD_region2\tMSD_region3\tMSD_complete", fmt="%1.5e")